            ...
            <form action="{{ route('product.update', $pro->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="product_name" id="product_name" value="{{ $pro->product_name }}"
                    ...
                    <div class="mb-4" id="variants-container">
                        ...
                        <div id="variants">
                            ...
                            <div class="flex items-center mb-2">
                                <select name="variants[{{ $key }}][type]" class="form-select mr-2" style="width: 25%;">
                                    <option value="size" {{ $item['type'] == "size" ? 'selected' : '' }}>Size</option>
                                    <option value="color" {{ $item['type'] == "color" ? 'selected' : '' }}>Color</option>
                                </select>
                                <input type="text" name="variants[{{ $key }}][name]" placeholder="Variant Name" value="{{ $item['name'] }}"
                                    class="form-input mr-2" style="width: 25%;">
                                <input type="number" name="variants[{{ $key }}][price]" placeholder="Price" min="0" value="{{ $item['price'] }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="product_sku" id="product_sku" value="{{ $pro->product_sku }}"
                            class="block w-full mt-1 text-sm border-gray-300 dark:text-gray-300 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue form-input"
                            required>
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm text-gray-700 dark:text-gray-400" for="product_unit">Product
                            Unit</label>
                        <input type="text" name="product_unit" id="product_unit" placeholder="Ex. - kg, litters, pieces" value="{{ $pro->product_unit }}"
                            class="block w-full mt-1 text-sm border-gray-300 dark:text-gray-300 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue form-input"
                            required>
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm text-gray-700 dark:text-gray-400" for="product_unit_value">Product Unit
                            Value</label>
                        <input type="number" name="product_unit_value" id="product_unit_value" value="{{ $pro->product_unit_value }}"
                    ...
                    <div class="mb-4">
                        <label class="block text-sm text-gray-700 dark:text-gray-400" for="selling_price">Selling
                            Price</label>
                        <input type="number" name="selling_price" id="selling_price" value="{{ $pro->selling_price }}"
                            class="block w-full mt-1 text-sm border-gray-300 dark:text-gray-300 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue form-input"
                            required>
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm text-gray-700 dark:text-gray-400" for="purchase_price">Purchase
                            Price</label>
                        <input type="number" name="purchase_price" id="purchase_price" value="{{ $pro->purchase_price }}"
                            class="block w-full mt-1 text-sm border-gray-300 dark:text-gray-300 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue form-input"
                            required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="discount" id="discount" value="{{ $pro->discount }}"
                            class="block w-full mt-1 text-sm border-gray-300 dark:text-gray-300 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue form-input"
                            min="0" max="100">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="tax" id="tax" value="{{ $pro->tax }}"
                            class="block w-full mt-1 text-sm border-gray-300 dark:text-gray-300 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue form-input"
                            min="0" max="100">
                    </div>
                    ...
                    <!-- Product Image -->
                    <div class="mb-4">
                        <label class="block text-sm text-gray-700 dark:text-gray-400" for="product_image">Product Image</label>
                        ...
                        @if ($pro->product_image)
                            <div class="mt-2">
                                <img src="/public/{{ Storage::url($pro->product_image) }}" alt="Product Image" class="max-w-xs" style="width: 25%;">
                            </div>
                        @endif
                        <!-- Error message -->
                        @error('product_image')
